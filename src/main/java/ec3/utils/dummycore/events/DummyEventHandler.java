...
public class DummyEventHandler {
        ...
        if (packetData != null && packetData.length > 0) {
            try {
                ...
                if (modData.fieldName.equalsIgnoreCase("mod")
                    && modData.fieldValue.equalsIgnoreCase("dummycore.tilesync")) {
                ...
                if (modData.fieldName.equalsIgnoreCase("mod")
                    && modData.fieldValue.equalsIgnoreCase("dummycore.particle")) {
                ...
                if (modData.fieldName.equalsIgnoreCase("mod")
                    && modData.fieldValue.equalsIgnoreCase("dummycore.sound")) {
                ...
                if (modData.fieldName.equalsIgnoreCase("mod")
                    && modData.fieldValue.equalsIgnoreCase("dummycore.infosync")) {
                ...
                if (modData.fieldName.equalsIgnoreCase("mod")
                    && modData.fieldValue.equalsIgnoreCase("dummycore.playerinfosync")) {
                ...
                if (modData.fieldName.equalsIgnoreCase("mod")
                    && modData.fieldValue.equalsIgnoreCase("dummycore.biomechange")) {
                    int x = Integer.parseInt(packetData[1].fieldValue);
                ...
                if (modData.fieldName.equalsIgnoreCase("mod")
                    && modData.fieldValue.equalsIgnoreCase("dummyCore.buttonpress")) {
                ...
                if (modData.fieldName.equalsIgnoreCase("mod")
                    && modData.fieldValue.equalsIgnoreCase("dummyCore.guiButton")) {
                    int id = Integer.parseInt(packetData[1].fieldValue);
                    ...
                    for (int i = 8; i < packetData.length; ++i) data[i - 8] = packetData[i];
                    Side side = FMLCommonHandler.instance()
                        .getEffectiveSide();
                    if (side == Side.SERVER) {
                        MinecraftServer server = MinecraftServer.getServer();
                        ...
                        MinecraftForge.EVENT_BUS
                            .post(new OnClientButtonPress(id, pClName, bClName, player, x, y, z, data));
                    }
                }
    ...
    private void actionsTick() {
        if (!MiscUtils.actions.isEmpty()) for (int i = 0; i < MiscUtils.actions.size(); ++i) {
