...
import ec3.common.blocks.BlockMIM;
import ec3.common.blocks.BlockMINEjector;
import ec3.common.blocks.BlockMINInjector;
...
public class RenderBlocksEC implements ISimpleBlockRenderingHandler {
    ...
    public void renderInventoryBlock(Block block, int metadata, int modelId, RenderBlocks renderer) {
        ...
        if (block instanceof BlockChestEC) {
            GL11.glPushMatrix();
            GL11.glRotated(180, 1, 0, 0);
            GL11.glTranslatef(-0.5F, -0.5F, -0.5F);
            Minecraft.getMinecraft().renderEngine
                .bindTexture(metadata == 0 ? RenderMagicalChest.magicalTextures : RenderMagicalChest.voidTextures);
        ...
        if (block instanceof BlockMithrilineCrystal) {
            ...
            Minecraft.getMinecraft().renderEngine.bindTexture(
                metadata == 0 ? RenderMithrilineCrystal.textures_mithriline
                    : metadata == 3 ? RenderMithrilineCrystal.textures_pale
                        : metadata == 6 ? RenderMithrilineCrystal.textures_void
                            : metadata == 9 ? RenderMithrilineCrystal.textures_demonic
                                : RenderMithrilineCrystal.textures_shade);
        ...
        if (block instanceof BlockMINEjector) {
            ...
            if (!advanced) render.bindTexture(RenderMINEjector.overlay);
            else render.bindTexture(RenderMINEjector.overlayA);
            RenderMINEjector.model.renderPart("pCube2");
            if (!advanced) render.bindTexture(RenderMINEjector.rings);
            else render.bindTexture(RenderMINEjector.ringsA);
        ...
        if (block instanceof BlockMINInjector) {
            ...
            if (!advanced) render.bindTexture(RenderMINInjector.glass);
            else render.bindTexture(RenderMINInjector.glass);
            RenderMINInjector.model.renderPart("pSphere1");
            if (!advanced) render.bindTexture(RenderMINInjector.rings);
            else render.bindTexture(RenderMINInjector.ringsA);
        ...
        if (block instanceof BlockDropsOre) {
            ...
            renderer.setOverrideBlockTexture(
                metadata < 5 ? dr.icons[0] : metadata >= 5 && metadata < 10 ? dr.icons[1] : dr.icons[2]);
        ...
        if (block instanceof BlockDrops) {
            switch (metadata) {
                case 0: {
                    renderer.setOverrideBlockTexture(
                        Block.getBlockFromName("minecraft:lava")
                            .getBlockTextureFromSide(0));
                    break;
                }
                case 1: {
                    renderer.setOverrideBlockTexture(
                        Block.getBlockFromName("minecraft:water")
                            .getBlockTextureFromSide(0));
                    break;
                }
                case 2: {
        ...
        if (block instanceof BlockCorruptionLight) {
            GL11.glPushMatrix();
        ...
        if (block instanceof BlockRayTower) {
            if (metadata == 0) {
                ...
                renderInventoryBlockWithSize(
                    renderer,
                    Blocks.glass,
                    ECBlocks.fortifiedGlass.getBlockTextureFromSide(0),
                    0.81F,
                    1.1F,
                    0.81F,
                    0,
        ...
        if (block instanceof BlockMoonWell) {
            ...
            renderInventoryBlockWithSize(
                renderer,
                Blocks.glass,
                Blocks.stained_glass.getIcon(0, 2),
                0.9F,
                0.7F,
                0.9F,
                0,
        ...
        if (block instanceof BlockMagicalDisplay) {
            renderInventoryBlockWithSize(
                renderer,
                Blocks.glass,
                ECBlocks.magicalDisplay.getIcon(0, 0),
                1F,
                1F,
                0.1F,
                0,
        ...
        if (block instanceof BlockMagicalQuarry) {
            renderInventoryBlockWithSize(
                renderer,
                Blocks.glass,
                ECBlocks.fortifiedGlass.getIcon(0, 0),
                1F,
                1F,
                1F,
                0,
            ...
            renderInventoryBlockWithSize(
                renderer,
                Blocks.glass,
                ECBlocks.fortifiedStone.getIcon(0, 0),
                0.99F,
                0.2F,
                0.99F,
                0,
            ...
            renderInventoryBlockWithSize(
                renderer,
                Blocks.glass,
                ECBlocks.magicalQuarry.getIcon(0, 0),
                0.2F,
                0.5F,
                0.2F,
                0,
        ...
        if (block instanceof BlockRedstoneTransmitter) {
            ...
            renderInventoryBlockWithSize(
                ...
                Blocks.redstone_torch.getIcon(0, 0),
                0.0001F,
                1F,
                1F,
                0.05F,
        ...
        if (block instanceof BlockMRUCoil_Coil) {
            renderInventoryBlockWithSize(
                renderer,
                Blocks.glass,
                Blocks.end_portal_frame.getIcon(1, 0),
                0.4F,
                0.2F,
                0.4F,
                0,
            ...
            renderInventoryBlockWithSize(
                renderer,
                Blocks.glass,
                ECBlocks.magicPlating.getIcon(1, 0),
                0.1F,
                0.7F,
                0.1F,
                0,
            ...
            renderInventoryBlockWithSize(
                renderer,
                Blocks.glass,
                ECBlocks.ecEjector.getIcon(1, 0),
                0.3F,
                0.3F,
                0.3F,
                0,
        ...
        if (block instanceof BlockCorruptionCleaner) {
            ...
            renderInventoryBlockWithSize(
                renderer,
                Blocks.glass,
                Blocks.diamond_block.getIcon(0, 0),
                0.4F,
                0.2F,
                0.4F,
                0F,
        ...
        if (block instanceof BlockFancy) {
            ...
            renderInventoryBlockWithSize(
                renderer,
                Blocks.glass,
                ((BlockFancy) block).overlayIcons[metadata],
                1,
                1,
                1,
                0.0F,
    ...
    public void renderInventoryBlockWithSize(RenderBlocks renderer, Block b, IIcon icon, float scaleX, float scaleY,
        float scaleZ, float offsetX, float offsetY, float offsetZ) {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        if (block instanceof BlockRedstoneTransmitter) {
            renderer.setOverrideBlockTexture(ECBlocks.fortifiedStone.getBlockTextureFromSide(0));
            IIcon redstoneIcon = ECBlocks.demonicPlating.getBlockTextureFromSide(0);
            switch (metadata) {
                case 0: {
        ...
        if (block instanceof BlockDrops) {
            ...
            renderer.renderStandardBlockWithColorMultiplier(
                Block.getBlockFromName("minecraft:glass"),
                x,
                y,
                z,
                1.0F,
        ...
        if (block instanceof BlockDropsOre) {
            ...
            renderer.useInventoryTint = false;
            GL11.glPushMatrix();
            renderTesselatedTextureByPoints(
                world,
                block,
                renderer,
                x,
                ...
                0.99D,
                0.99D,
                0.99D, // SOUTH-TOP-EAST
                0.01D,
                0.99D,
                0.99D, // SOUTH-TOP-WEST
                0.99D,
                0.99D,
                0.01D, // SOUTH-TOP-EAST
                0.01D,
                0.99D,
                0.01D, // NORTH-TOP-WEST
                0.99D,
                0.01D,
                0.99D, // SOUTH-BOT-EAST
                0.01D,
                0.01D,
                0.99D, // SOUTH-BOT-WEST
                0.99D,
                0.01D,
                0.01D, // SOUTH-BOT-EAST
                0.01D,
                0.01D,
                0.01D // NORTH-BOT-WEST
            );
            GL11.glPopMatrix();
            renderer.useInventoryTint = true;
            GL11.glPopMatrix();
        ...
        if (block instanceof BlockRayTower) {
            if (world.getBlockMetadata(x, y, z) == 0) {
                renderer.renderAllFaces = true;
                renderer.setOverrideBlockTexture(ECBlocks.fortifiedGlass.getBlockTextureFromSide(0));
        ...
        if (block instanceof BlockMagicalQuarry) {
            renderer.renderAllFaces = true;
            renderer.setOverrideBlockTexture(ECBlocks.fortifiedGlass.getIcon(0, 0));
            renderer.setRenderBounds(0, 0, 0, 1, 1, 1);
            renderer.renderStandardBlock(Blocks.glass, x, y, z);
            renderer.setOverrideBlockTexture(ECBlocks.fortifiedStone.getIcon(0, 0));
            ...
            renderer.renderStandardBlock(Blocks.glass, x, y, z);
            renderer.setOverrideBlockTexture(ECBlocks.magicalQuarry.getIcon(0, 0));
        ...
        if (block instanceof BlockMRUCoil_Coil) {
            ...
            renderer.renderStandardBlock(Blocks.glass, x, y, z);
            renderer.setOverrideBlockTexture(ECBlocks.magicPlating.getIcon(0, 0));
        ...
        if (block instanceof BlockReactorSupport) {
            ...
            if (!(b_0 instanceof BlockReactorSupport)) {
                ...
                renderer.renderStandardBlock(Blocks.glass, x, y, z);
            } else if (!(b_1 instanceof BlockReactorSupport) && b_0 instanceof BlockReactorSupport) {
                renderer.setOverrideBlockTexture(ECBlocks.magicPlating.getIcon(0, 0));
    ...
    public void renderTesselatedTextureByPoints(IBlockAccess world, Block b, RenderBlocks renderer, double x, double y,
        double z, double red, double green, double blue, double alpha, int brightness, IIcon renderWith,
        double... points) {
        if (renderer.renderAllFaces || b.shouldSideBeRendered(
            world,
            MathHelper.floor_double(x - 1),
    ...
    public void renderFace(RenderBlocks renderer, Block b, double x, double y, double z, double red, double green,
        double blue, double alpha, int brightness, IIcon icon, double... renderPts) {
