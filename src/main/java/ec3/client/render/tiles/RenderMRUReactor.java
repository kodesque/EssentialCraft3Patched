package ec3.client.render.tiles;
...
public class RenderMRUReactor extends TileEntitySpecialRenderer {
    ...
    public static final ResourceLocation stextures = new ResourceLocation(
        "essentialcraft:textures/special/models/sphere.png");
    public static final IModelCustom smodel = AdvancedModelLoader
        .loadModel(new ResourceLocation("essentialcraft:textures/special/models/sphere.obj"));
     ...
     */
    public void doRender(TileMRUReactor p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
        ...
        GL11.glPushMatrix();
        if (p_76986_1_.isStructureCorrect()) for (int i = 0; i < p_76986_1_.lightnings.size(); ++i) {
            ArcFX l = p_76986_1_.lightnings.get(i);
