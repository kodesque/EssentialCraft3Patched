...
public class BlockConnectedTextures extends Block {
    ...
    public static final String[] field_150921_b = new String[] { "white", "red", "green", "brown", "blue", "purple",
        "cyan", "lightgray", "gray", "pink", "lime", "yellow", "lightblue", "magenta", "orange", "black" };
    public static final int[] field_150922_c = new int[] { 15790320, 11743532, 3887386, 5320730, 2437522, 8073150,
        2651799, 11250603, 4408131, 14188952, 4312372, 14602026, 6719955, 12801229, 15435844, 1973019 };
    ...
    public BlockConnectedTextures(Material p_i45394_1_) {
        super(p_i45394_1_);
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int sideHit, float vecX,
                                    ...
                                    for (int dz = -2; dz <= 2; ++dz) {
                                        ...
                                        if (b == this) {
                                            b.recolourBlock(
                                                ...
                                                y + dy,
                                                z + dz,
                                                ForgeDirection.VALID_DIRECTIONS[sideHit],
                                                color);
