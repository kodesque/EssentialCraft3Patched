    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_) {
        ...
        if (this.getType() == 2) {
            ...
            if (this.worldObj.rand.nextFloat() < 0.1F) {
                ...
                switch (i) {
                    case 0: {
                        this.dropItem(ECItems.magicArmorItems[12], 1);
                        return;
                    }
                    case 1: {
                        this.dropItem(ECItems.magicArmorItems[13], 1);
                        return;
                    }
                    case 2: {
                        this.dropItem(ECItems.magicArmorItems[14], 1);
                        return;
                    }
                    case 3: {
                        this.dropItem(ECItems.magicArmorItems[15], 1);
                        return;
                    }
                }
            }
