    ...
    public boolean hitEntity(ItemStack p_77644_1_, EntityLivingBase p_77644_2_, EntityLivingBase p_77644_3_) {
        try {
            if (p_77644_3_ instanceof EntityPlayer) {
                ...
                if ((ECUtils.tryToDecreaseMRUInStorage((EntityPlayer) p_77644_3_, -250)
                    || this.setMRU(p_77644_1_, -250))) {
                    int att = ECUtils.getData(player)
                        .getMatrixTypeID();
                    if (att == 1) {
                        PotionEffect eff = p_77644_2_.getActivePotionEffect(Potion.digSlowdown);
                        if (eff != null && p_77644_2_.hurtResistantTime == 0
                            || p_77644_2_.hurtResistantTime >= 15 && eff != null) {
                            int buffLevel = eff.getAmplifier();
                            p_77644_2_
                                .addPotionEffect(new PotionEffect(Potion.digSlowdown.id, 100, eff.getAmplifier() + 1));
