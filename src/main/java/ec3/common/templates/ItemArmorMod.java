...
public class ItemArmorMod extends ItemArmor
    ...
    public Multimap getAttributeModifiers(ItemStack stack) {
        ...
        if (this == ECItems.magicArmorItems[5]) mods.put(
            SharedMonsterAttributes.maxHealth.getAttributeUnlocalizedName(),
            new AttributeModifier(UUID.fromString("1bca943c-3cf5-42cc-a3df-2ed994ae0000"), "hp", 20D, 0));

        if (this == ECItems.magicArmorItems[7]) mods.put(
            SharedMonsterAttributes.movementSpeed.getAttributeUnlocalizedName(),
            new AttributeModifier(UUID.fromString("1bca943c-3cf5-42cc-a3df-2ed994ae0000"), "movespeed", 0.075D, 0));

        if (this == ECItems.magicArmorItems[9]) mods.put(
            SharedMonsterAttributes.maxHealth.getAttributeUnlocalizedName(),
            new AttributeModifier(UUID.fromString("1bca943c-3cf5-42cc-a3df-2ed994ae0000"), "hp", 30D, 0));

        if (this == ECItems.magicArmorItems[11]) mods.put(
            SharedMonsterAttributes.movementSpeed.getAttributeUnlocalizedName(),
            new AttributeModifier(UUID.fromString("1bca943c-3cf5-42cc-a3df-2ed994ae0000"), "movespeed", 0.1D, 0));
    ...
    public String getArmorTexture(ItemStack itemstack, Entity entity, int slot, String type) {
        switch (slot) {
            case 2:
                return "essentialcraft:textures/special/models/" + armorTexture + "_1.png"; // 2 should be the slot for
                                                                                            // legs
            default:
                return "essentialcraft:textures/special/models/" + armorTexture + "_0.png";
        }
    }
    ...
    public void getSubItems(Item par1, CreativeTabs par2CreativeTabs, List par3List) {
        if (this.aType != 1) super.getSubItems(par1, par2CreativeTabs, par3List);
        else for (int var4 = 0; var4 < 1; ++var4) {
        ...
        if (this.aType != 1) {
            if (!source.isUnblockable()) {
                ...
                return new ArmorProperties(
                    0,
                    aarmor.damageReduceAmount / 25D,
                    aarmor.getMaxDamage() + 1 - armor.getItemDamage());
            } else return new ArmorProperties(0, 0, armor.getMaxDamage() + 1 - armor.getItemDamage());
        } else {
