...
public class StructureModernShaftPieces {
    ...
    public static void registerStructurePieces() {
        MapGenStructureIO.func_143031_a(Corridor.class, "MMSCorridor");
        MapGenStructureIO.func_143031_a(Cross.class, "MMSCrossing");
        MapGenStructureIO.func_143031_a(Room.class, "MMSRoom");
        MapGenStructureIO.func_143031_a(Stairs.class, "MMSStairs");
    }
    ...
    private static StructureComponent getRandomComponent(List p_78815_0_, Random p_78815_1_, int p_78815_2_,
        ...
        if (j1 >= 80) {
            structureboundingbox = Cross
                .findValidPlacement(p_78815_0_, p_78815_1_, p_78815_2_, p_78815_3_, p_78815_4_, p_78815_5_);

            if (structureboundingbox != null) {
                return new Cross(p_78815_6_, p_78815_1_, structureboundingbox, p_78815_5_);
            }
        } else if (j1 >= 70) {
            structureboundingbox = Stairs
                .findValidPlacement(p_78815_0_, p_78815_1_, p_78815_2_, p_78815_3_, p_78815_4_, p_78815_5_);
    ...
    public static class Corridor extends StructureComponent {
        ...
        public void buildComponent(StructureComponent p_74861_1_, List p_74861_2_, Random p_74861_3_) {
            ...
            switch (this.coordBaseMode) {
                case 0:
                    if (j <= 1) {
                        StructureModernShaftPieces.getNextMineShaftComponent(
                            p_74861_1_,
                            p_74861_2_,
                            p_74861_3_,
                            this.boundingBox.minX,
                            this.boundingBox.minY - 1 + p_74861_3_.nextInt(3),
        ...
        protected boolean generateStructureChestContents(World p_74879_1_, StructureBoundingBox p_74879_2_,
            ...
            if (p_74879_2_.isVecInside(i1, j1, k1) && p_74879_1_.getBlock(i1, j1, k1)
                ...
                p_74879_1_.setBlock(i1, j1 - 1, k1, ECBlocks.voidStone, 0, 2);
                ...
                WeightedRandomChestContent
                    .generateChestContents(p_74879_3_, p_74879_7_, entityminecartchest, p_74879_8_);
                ...
                for (j = 0; j <= 2; ++j) {
                    for (k = 0; k <= i; ++k) {
                        ...
                        if (block1.getMaterial() == Material.air) {
                            byte b1 = -1;
                            this.placeBlockAtCurrentPosition(p_74875_1_, ECBlocks.voidStone, 0, j, b1, k, p_74875_3_);
                        }
                    }
                }
            ...
            if (this.isLiquidInStructureBoundingBox(p_74875_1_, p_74875_3_)) {
                ...
                for (int i = this.boundingBox.minX; i <= this.boundingBox.maxX; ++i) {
                    for (int j = this.boundingBox.minZ; j <= this.boundingBox.maxZ; ++j) {
                        if (this.getBlockAtCurrentPosition(p_74875_1_, i, this.boundingBox.minY - 1, j, p_74875_3_)
                            .getMaterial() == Material.air) {
    ...
    public static class Room extends StructureComponent {
        ...
        public void buildComponent(StructureComponent p_74861_1_, List p_74861_2_, Random p_74861_3_) {
            ...
            for (j = 0; j < this.boundingBox.getXSize(); j += 4) {
                ...
                structurecomponent1 = StructureModernShaftPieces.getNextMineShaftComponent(
                    p_74861_1_,
                    p_74861_2_,
                    p_74861_3_,
                    this.boundingBox.minX + j,
                    this.boundingBox.minY + p_74861_3_.nextInt(k) + 1,
                    this.boundingBox.minZ - 1,
                    2,
                    i);
