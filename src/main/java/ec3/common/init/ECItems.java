...
public class ECItems {
    ...
    public static ECItems instance;
    ...
    public void loadItems() {
        ...
        elemental_pick = new ItemPickaxeMod(elemental).setUnlocalizedName("essentialcraft:elemental_pick")
            .setTextureName("essentialcraft:tools/elemental_pickaxe")
            .setMaxStackSize(1)
            .setFull3D();
        ...
        elemental_axe = new ItemAxeMod(elemental).setUnlocalizedName("essentialcraft:elemental_axe")
            .setTextureName("essentialcraft:tools/elemental_axe")
            .setMaxStackSize(1)
            .setFull3D();
        ...
        elemental_hoe = new ItemHoeMod(elemental).setUnlocalizedName("essentialcraft:elemental_hoe")
            .setTextureName("essentialcraft:tools/elemental_hoe")
            .setMaxStackSize(1)
            .setFull3D();
        ...
        elemental_shovel = new ItemShovelMod(elemental).setUnlocalizedName("essentialcraft:elemental_shovel")
            .setTextureName("essentialcraft:tools/elemental_shovel")
            .setMaxStackSize(1)
            .setFull3D();
        Item.itemRegistry
            .addObject(getIdForItem("elemental_shovel"), "essentialcraft:elemental_shovel", elemental_shovel);
        ItemRegistry.registerItem(elemental_shovel, EssentialCraftCore.class);
        elemental_sword = new ItemSwordMod(elemental).setUnlocalizedName("essentialcraft:elemental_sword")
            .setTextureName("essentialcraft:tools/elemental_sword")
            .setMaxStackSize(1)
            .setFull3D();
        ...
        bound_gem = new ItemBoundGem().setUnlocalizedName("essentialcraft:bound_gem")
            .setTextureName("essentialcraft:gem_bound");
        ...
        magicMonocle = registerItemSimple(
            magicMonocle,
            ItemMonocle.class,
            "magicMonocle",
            "tools/magicMonocle",
        ...
        record_everlastingSummer = new ItemRecordMod("letsbefriends").setUnlocalizedName("essentialcraft:record")
        ...
        record_papersPlease = new ItemRecordMod("arstotzkan").setUnlocalizedName("essentialcraft:record_a")
            .setTextureName("record_far");
        ...
        record_secret = new ItemRecordMod("secret").setUnlocalizedName("essentialcraft:record_secret")
        ...
        matrixProj = registerItemSimple(
            matrixProj,
            ItemMRUMatrixProjection.class,
            "mruMatrixProjection",
            "mruMatrix_empty",
            0,
            false,
        ...
        twinkling_titanite = registerItemSimple(
            twinkling_titanite,
            Item.class,
            "twinkling_titanite",
            "misc/twinkling_titanite",
            0,
            false,
            64);
        ...
        genericItem = registerItemSimple(genericItem, ItemGenericEC.class, "genItem", "magicalSlag", 0, false, 64);
        magicalAlloy = registerItemSimple(
            magicalAlloy,
            ItemMagicalAlloy.class,
            "magicalAlloy",
            "magicalSlag",
            0,
            false,
        ...
        storage = new ItemMRUStorageNBTTag(new int[] { 500, 5000, 30000, 120000, 1000000 })
            .setUnlocalizedName("essentialcraft:storage")
            .setTextureName("essentialcraft:soulStone");
        ...
        magicalDigger = registerItemSimple(
            magicalDigger,
            ItemMagicalDigger.class,
            "magicalDigger",
            "tools/magicalDigger",
            0,
            true,
            1);
        spawnerCollector = registerItemSimple(
            spawnerCollector,
            ItemSpawnerCollector.class,
            "spawnerCollector",
            "tools/spawnerCollector",
            0,
            true,
            1);
        staffOfLife = registerItemSimple(
            staffOfLife,
            ItemLifeStaff.class,
            "staffOfLife",
            "tools/staffOfLife",
        ...
        emeraldHeart = registerItemSimple(
            emeraldHeart,
            ItemEmeraldHeart.class,
            "emeraldHeart",
            "tools/emeraldHeart",
            0,
            true,
            1);
        magicalShield = registerItemSimple(
            magicalShield,
            ItemMagicalShield.class,
            "magicalShield",
            "tools/magicalShield",
            0,
            true,
            1);
        spikyShield = registerItemSimple(
            spikyShield,
            ItemSpikyShield.class,
            "spikyShield",
            "tools/spikyShield",
            0,
            true,
            1);
        magicWaterBottle = registerItemSimple(
            magicWaterBottle,
            ItemMagicalWater.class,
            "magicWaterBottle",
            "tools/magicWaterBottle",
            0,
            true,
            1);
        magicalPorkchop = registerItemSimple(
            magicalPorkchop,
            ItemMagicalPorkchop.class,
            "magicalPorkchop",
            "tools/magicalPorkchop",
            0,
            true,
            1);
        charm = registerItemSimple(charm, ItemCharm.class, "charm", "tools/charmFire", 0, true, 1);
        magicalWings = registerItemSimple(
            magicalWings,
            ItemMagicalWings.class,
            "magicalWings",
            "tools/magicalWings",
            0,
            true,
        ...
        elementalFuel = registerItemSimple(
            elementalFuel,
            ItemEssentialFuel.class,
            "elementalFuel",
            "tools/emeraldHeart",
            0,
            false,
        ...
        wFocus = registerItemSimple(
            wFocus,
            ItemElementalFocus.class,
            "wFocus",
            "elemental/eFocusWater",
            3000,
            false,
            1);
        eFocus = registerItemSimple(
            eFocus,
            ItemElementalFocus.class,
            "eFocus",
            "elemental/eFocusEarth",
            3000,
            false,
            1);
        aFocus = registerItemSimple(aFocus, ItemElementalFocus.class, "aFocus", "elemental/eFocusAir", 3000, false, 1);

        fruit = new ItemFood(8, 10F, false).setUnlocalizedName("essentialcraft:fruit_Item")
            .setTextureName("essentialcraft:fruit");
        ...
        bottledWind = new ItemWindKeeper(10).setUnlocalizedName("essentialcraft:bottledWind")
            .setTextureName("essentialcraft:bottledWind");
        ...
        imprisonedWind = new ItemWindKeeper(25).setUnlocalizedName("essentialcraft:imprisonedWind")
            .setTextureName("essentialcraft:imprisonedWind");
        ...
        windKeeper = new ItemWindKeeper(100).setUnlocalizedName("essentialcraft:windKeeper")
            .setTextureName("essentialcraft:windkeeper");
        ...
        elementalSword = registerItemSimple(
            elementalSword,
            ItemElementalSword.class,
            "elementalSword",
            "tools/elementalSword",
            0,
            false,
            1);
        ember = registerItemSimple(ember, ItemEmber.class, "ember", "windTablet", 0, false, 16);

        magicArmorItems[0] = new ItemArmorMod(magicArmorMaterial, 4, 0, 0).setArmorTexture("armorEC3Magic")
            .setUnlocalizedName("essentialcraft:helm_magic")
            .setMaxDamage(512);
        ...
        magicArmorItems[1] = new ItemArmorMod(magicArmorMaterial, 4, 1, 0).setArmorTexture("armorEC3Magic")
            .setUnlocalizedName("essentialcraft:chest_magic")
            .setMaxDamage(1536);
        ...
        magicArmorItems[2] = new ItemArmorMod(magicArmorMaterial, 4, 2, 0).setArmorTexture("armorEC3Magic")
            .setUnlocalizedName("essentialcraft:legs_magic")
            .setMaxDamage(1024);
        ...
        magicArmorItems[3] = new ItemArmorMod(magicArmorMaterial, 4, 3, 0).setArmorTexture("armorEC3Magic")
            .setUnlocalizedName("essentialcraft:boots_magic")
            .setMaxDamage(512);
        ...
        magicArmorItems[4] = new ItemArmorMod(voidArmorMaterial, 4, 0, 1).setArmorTexture("armorEC3Void")
            .setUnlocalizedName("essentialcraft:helm_void")
            .setMaxDamage(512 * 4);
        ...
        MiscUtils.registerDescriptionFor(
            magicArmorItems[4].getUnlocalizedName(),
            "Converts life energy of fallen foes to your hunger",
            EnumChatFormatting.ITALIC);

        magicArmorItems[5] = new ItemArmorMod(voidArmorMaterial, 4, 1, 1).setArmorTexture("armorEC3Void")
            .setUnlocalizedName("essentialcraft:chest_void")
            .setMaxDamage(1536 * 4);
        ...
        MiscUtils.registerDescriptionFor(
            magicArmorItems[5].getUnlocalizedName(),
            "Can dodge 20% of attacks",
            EnumChatFormatting.ITALIC);

        magicArmorItems[6] = new ItemArmorMod(voidArmorMaterial, 4, 2, 1).setArmorTexture("armorEC3Void")
            .setUnlocalizedName("essentialcraft:legs_void")
            .setMaxDamage(1024 * 4);
        ...
        MiscUtils.registerDescriptionFor(
            magicArmorItems[6].getUnlocalizedName(),
            "Can phase-shift through monsters",
            EnumChatFormatting.ITALIC);

        magicArmorItems[7] = new ItemArmorMod(voidArmorMaterial, 4, 3, 1).setArmorTexture("armorEC3Void")
            .setUnlocalizedName("essentialcraft:boots_void")
            .setMaxDamage(512 * 4);
        ...
        MiscUtils.registerDescriptionFor(
            magicArmorItems[7].getUnlocalizedName(),
            "Negates 90% of falldamage",
            EnumChatFormatting.ITALIC);

        magicArmorItems[8] = new ItemArmorMod(inquisArmorMaterial, 4, 0, 2).setArmorTexture("armorEC3Inquisitorium")
            .setUnlocalizedName("essentialcraft:helm_inq")
            .setMaxDamage(512 * 10);
        ...
        MiscUtils.registerDescriptionFor(
            magicArmorItems[8].getUnlocalizedName(),
            "Linses created from the moonlight metal to see unpurity",
            EnumChatFormatting.ITALIC);

        magicArmorItems[9] = new ItemArmorMod(inquisArmorMaterial, 4, 1, 2).setArmorTexture("armorEC3Inquisitorium")
            .setUnlocalizedName("essentialcraft:chest_inq")
            .setMaxDamage(1536 * 10);
        ...
        MiscUtils.registerDescriptionFor(
            magicArmorItems[9].getUnlocalizedName(),
            "Be quiet, Dominique!",
            EnumChatFormatting.ITALIC);

        magicArmorItems[10] = new ItemArmorMod(inquisArmorMaterial, 4, 2, 2).setArmorTexture("armorEC3Inquisitorium")
            .setUnlocalizedName("essentialcraft:legs_inq")
            .setMaxDamage(1024 * 10);
        ...
        MiscUtils.registerDescriptionFor(
            magicArmorItems[10].getUnlocalizedName(),
            "Magic is a parasite. It must be wiped out!",
            EnumChatFormatting.ITALIC);

        magicArmorItems[11] = new ItemArmorMod(inquisArmorMaterial, 4, 3, 2).setArmorTexture("armorEC3Inquisitorium")
            .setUnlocalizedName("essentialcraft:boots_inq")
            .setMaxDamage(512 * 10);
        ...
        MiscUtils.registerDescriptionFor(
            magicArmorItems[11].getUnlocalizedName(),
            "Magic shall not prevail!",
            EnumChatFormatting.ITALIC);

        magicArmorItems[12] = new ItemArmorMod(ArmorMaterial.CLOTH, 4, 0, 3).setArmorTexture("armorEC3Wind")
            .setUnlocalizedName("essentialcraft:helm_wind")
            .setMaxDamage(128);
        ...
        magicArmorItems[13] = new ItemArmorMod(ArmorMaterial.CLOTH, 4, 1, 3).setArmorTexture("armorEC3Wind")
            .setUnlocalizedName("essentialcraft:chest_wind")
            .setMaxDamage(256 + 128);
        ...
        magicArmorItems[14] = new ItemArmorMod(ArmorMaterial.CLOTH, 4, 2, 3).setArmorTexture("armorEC3Wind")
            .setUnlocalizedName("essentialcraft:legs_wind")
            .setMaxDamage(256);
        ...
        magicArmorItems[15] = new ItemArmorMod(ArmorMaterial.CLOTH, 4, 3, 3).setArmorTexture("armorEC3Wind")
            .setUnlocalizedName("essentialcraft:boots_wind")
            .setMaxDamage(128);
        ...
        magmaticStaff = registerItemSimple(
            magmaticStaff,
            ItemMagmaticWand.class,
            "magmaticStaff",
            "tools/magmaticWand",
            0,
            true,
            1);
        magicalLantern = registerItemSimple(
            magicalLantern,
            ItemMagicLantern.class,
            "magicalLantern",
            "tools/elementalPurifier",
            0,
            true,
            1);
        magnetizingStaff = registerItemSimple(
            magnetizingStaff,
            ItemMagnetizingStaff.class,
            "magnetizingStaff",
            "tools/magnetizingStaff",
            0,
            true,
            1);

        research_book = registerItemSimple(
            research_book,
            ItemKnowledgeBook.class,
            "research_book",
            "book_knowledge",
            0,
            false,
        ...
        mruMover_t2 = registerItemSimple(
            mruMover_t2,
            ItemMRUMover.class,
            "mruMover_t2",
            "tools/mru_mover_t2",
        ...
        magicalChisel = registerItemSimple(
            magicalChisel,
            ItemMagicalChisel.class,
            "magicalChisel",
            "tools/magicalChisel",
            256,
            true,
        ...
        baublesCore = registerItemSimple(baublesCore, BaublesAccessory.class, "baublesCore", "???", 0, false, 1);
        ApiCore.allowsSeeingMRU.add(mruMover_t2);

        shadeSword = registerItemSimple(
            shadeSword,
            ItemShadeSword.class,
            "shadeSword",
            "tools/swordOfTheSHADE",
            0,
            true,
            1);
        shadeSlasher = registerItemSimple(
            shadeSlasher,
            ItemShadeSlasher.class,
            "shadeSlasher",
            "tools/slasherOfTheSHADE",
            0,
            true,
            1);
        shadeKnife = registerItemSimple(
            shadeKnife,
            ItemShadowKnife.class,
            "shadeKnife",
            "tools/shadowKnife",
            0,
            true,
            32);
        entityEgg = registerItemSimple(entityEgg, ItemSpawnEggEC.class, "entityEgg", "fruit", 0, false, 64);
        ...
        weak_elemental_axe = new ItemAxeMod(weakElemental).setUnlocalizedName("essentialcraft.weak_elemental_axe")
            .setTextureName("essentialcraft:tools/weak_axe")
            .setMaxStackSize(1)
            .setFull3D();
        ItemRegistry.registerItem(weak_elemental_axe, "weak_elemental_axe", EssentialCraftCore.class);
        weak_elemental_hoe = new ItemHoeMod(weakElemental).setUnlocalizedName("essentialcraft.weak_elemental_hoe")
            .setTextureName("essentialcraft:tools/weak_hoe")
            .setMaxStackSize(1)
            .setFull3D();
        ItemRegistry.registerItem(weak_elemental_hoe, "weak_elemental_hoe", EssentialCraftCore.class);
        weak_elemental_shovel = new ItemShovelMod(weakElemental)
            .setUnlocalizedName("essentialcraft.weak_elemental_shovel")
            .setTextureName("essentialcraft:tools/weak_shovel")
            .setMaxStackSize(1)
            .setFull3D();
        ...
        wind_elemental_pick = new ItemWindPickaxe(windElemental)
            .setUnlocalizedName("essentialcraft.wind_elemental_pick")
            .setTextureName("essentialcraft:tools/wind_pickaxe")
            .setMaxStackSize(1)
            .setFull3D();
        ItemRegistry.registerItem(wind_elemental_pick, "wind_elemental_pick", EssentialCraftCore.class);
        wind_elemental_shovel = new ItemWindShovel(windElemental)
            .setUnlocalizedName("essentialcraft.wind_elemental_shovel")
            .setTextureName("essentialcraft:tools/wind_shovel")
            .setMaxStackSize(1)
            .setFull3D();
        ItemRegistry.registerItem(wind_elemental_shovel, "wind_elemental_shovel", EssentialCraftCore.class);
        wind_elemental_axe = new ItemWindAxe(windElemental).setUnlocalizedName("essentialcraft.wind_elemental_axe")
            .setTextureName("essentialcraft:tools/wind_axe")
            .setMaxStackSize(1)
            .setFull3D();
        ItemRegistry.registerItem(wind_elemental_axe, "wind_elemental_axe", EssentialCraftCore.class);
        wind_elemental_hoe = new ItemWindHoe(windElemental).setUnlocalizedName("essentialcraft.wind_elemental_hoe")
            .setTextureName("essentialcraft:tools/wind_hoe")
            .setMaxStackSize(1)
            .setFull3D();
        ItemRegistry.registerItem(wind_elemental_hoe, "wind_elemental_hoe", EssentialCraftCore.class);
        wind_elemental_sword = new ItemWindSword(windElemental)
            .setUnlocalizedName("essentialcraft.wind_elemental_sword")
            .setTextureName("essentialcraft:tools/wind_sword")
            .setMaxStackSize(1)
            .setFull3D();
        ItemRegistry.registerItem(wind_elemental_sword, "wind_elemental_sword", EssentialCraftCore.class);

        wind_helmet = new ItemGenericArmor(windArmorMaterial, 0, 0).setUnlocalizedName("essentialcraft.wind_helmet")
            .setTextureName("essentialcraft:armor/wind_helmet")
            .setMaxDamage(312 * 2);
        ...
        wind_chestplate = new ItemGenericArmor(windArmorMaterial, 0, 1)
            .setUnlocalizedName("essentialcraft.wind_chestplate")
            .setTextureName("essentialcraft:armor/wind_chestplate")
            .setMaxDamage(312 * 4);
        ...
        wind_leggings = new ItemGenericArmor(windArmorMaterial, 0, 2).setUnlocalizedName("essentialcraft.wind_leggings")
            .setTextureName("essentialcraft:armor/wind_leggings")
            .setMaxDamage(312 * 3);
        ...
        wind_boots = new ItemGenericArmor(windArmorMaterial, 0, 3).setUnlocalizedName("essentialcraft.wind_boots")
            .setTextureName("essentialcraft:armor/wind_boots")
            .setMaxDamage(312 * 2);
        ...
        soulScriber = registerItemSimple(
            soulScriber,
            ItemSoulScriber.class,
            "soulScriber",
            "tools/soulScriber",
            32,
            true,
        ...
        magicalBuilder = registerItemSimple(
            magicalBuilder,
        ...
        computer_helmet = new ItemComputerArmor(computerArmorMaterial, 0, 0)
            .setUnlocalizedName("essentialcraft.computer_helmet")
            .setTextureName("essentialcraft:armor/computer_helmet")
            .setMaxDamage(16384);
        ...
        computer_chestplate = new ItemComputerArmor(computerArmorMaterial, 0, 1)
            .setUnlocalizedName("essentialcraft.computer_chestplate")
            .setTextureName("essentialcraft:armor/computer_chestplate")
            .setMaxDamage(16384);
        ...
        computer_leggings = new ItemComputerArmor(computerArmorMaterial, 0, 2)
            .setUnlocalizedName("essentialcraft.computer_leggings")
            .setTextureName("essentialcraft:armor/computer_leggings")
            .setMaxDamage(16384);
        ...
        computer_boots = new ItemComputerArmor(computerArmorMaterial, 0, 3)
            .setUnlocalizedName("essentialcraft.computer_boots")
            .setTextureName("essentialcraft:armor/computer_boots")
            .setMaxDamage(16384);
        ...
        computerBoard = registerItemSimple(
            computerBoard,
            ItemComputerBoard.class,
            "computerBoard",
            "antigravity_board",
            0,
            true,
        ...
        orbitalRemote = registerItemSimple(
            orbitalRemote,
            ItemOrbitalRemote.class,
            "orbitalRemote",
            "tools/orbitalStrikeRemote",
            0,
            true,
            1);

        record_robocalypse = new ItemRecordMod("hologram").setUnlocalizedName("essentialcraft:hologramRec")
            .setTextureName("essentialcraft:record_holobattle");

        dividingGun = registerItemSimple(
            dividingGun,
            ItemDividerGun.class,
            "dividerGun",
            "tools/dividingGun",
            0,
            true,
        ...
        craftingFrame = registerItemSimple(
            craftingFrame,
            ItemCraftingFrame.class,
            "craftingFrame",
            "itemCrafter",
            0,
            false,
            1);
        collectedSpawner = registerItemSimple(
            collectedSpawner,
            ItemCollectedMonsterSpawner.class,
            "collectedSpawner",
            "collectedSpawner",
            0,
            false,
    ...
    @SuppressWarnings("deprecation")
    public static Item registerItemSimple(Item i, Class<? extends Item> itemClass, String name, String textureName,
        int damage, boolean full3D, int stackSize) {
        try {
            if (textureName.indexOf(":") != -1) i = itemClass.newInstance()
                .setUnlocalizedName("essentialcraft:" + name)
                .setTextureName(textureName)
                .setMaxDamage(damage)
                .setMaxStackSize(stackSize);
            else i = itemClass.newInstance()
                .setUnlocalizedName("essentialcraft:" + name)
                .setTextureName("essentialcraft:" + textureName)
                .setMaxDamage(damage)
                .setMaxStackSize(stackSize);
            if (full3D) i.setFull3D();
