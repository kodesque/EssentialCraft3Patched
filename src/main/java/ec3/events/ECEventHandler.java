...
public class ECEventHandler {
        ...
        if (event.left != null && event.left.getItem() instanceof ItemGun && event.right != null) {
            ...
            if (tag.hasKey("base")) {
                ...
                if (material != null) {
                    ...
                    MiscUtils.getStackTag(result)
                        .setFloat("gunDamage", 0);
                    event.cost = 4;
    ...
    public ItemStack findShearItem(Entity e) {
        ...
        if (e instanceof EntityCow) return new ItemStack(Items.leather, rN, 0);
        if (e instanceof EntityChicken) return new ItemStack(Items.feather, rN, 0);
        if (e instanceof EntitySquid) return new ItemStack(Items.dye, rN, 0);
        if (e instanceof EntitySpider) return new ItemStack(Items.string, rN, 0);
        if (e instanceof EntityCreeper) return new ItemStack(Items.gunpowder, rN, 0);
        if (e instanceof EntitySkeleton) return new ItemStack(Items.dye, rN, 15);
        if (e instanceof EntityMagmaCube) return new ItemStack(Items.magma_cream, rN, 0);
        if (e instanceof EntitySlime) return new ItemStack(Items.slime_ball, rN, 0);
        if (e instanceof EntityZombie) return new ItemStack(Items.rotten_flesh, rN, 0);
        if (e instanceof EntitySnowman) return new ItemStack(Blocks.snow, rN, 0);
        return null;
    }
                ...
                if (b != null) {
                    for (int i = 0; i < b.getSizeInventory(); ++i) {
                        ...
                        if (is != null && is.getItem() != null
                            && is.getItem() instanceof BaublesAccessory
                            && is.getItemDamage() == 30) changeTarget = true;
                    }
                }
                if (changeTarget) {
                    List<EntityLivingBase> entities = event.entityLiving.worldObj.getEntitiesWithinAABB(
                        EntityLivingBase.class,
                        AxisAlignedBB
                            .getBoundingBox(
                                event.entityLiving.posX - 0.5D,
                                event.entityLiving.posY - 0.5D,
                                event.entityLiving.posZ - 0.5D,
                                event.entityLiving.posX + 0.5D,
                                event.entityLiving.posY + 0.5D,
                                event.entityLiving.posZ + 0.5D)
                            .expand(6, 3, 6));
                    for (int i = 0; i < entities.size(); ++i) {
                        ...
                        if (base == event.entityLiving || base == event.target) entities.remove(i);
                    }
                    if (!entities.isEmpty()) {
    ...
    public void xpEvent(PlayerPickupXpEvent event) {
        ...
        if (b != null) {
            for (int i = 0; i < b.getSizeInventory(); ++i) {
                ...
                if (is != null && is.getItem() != null
                    && is.getItem() instanceof BaublesAccessory
                    && is.getItemDamage() == 29) edouble = true;
            }
        }
        if (edouble) event.orb.xpValue *= 2;
    }
        ...
        if (player != null) {
            ...
            if (b != null) {
                for (int i = 0; i < b.getSizeInventory(); ++i) {
                    ...
                    if (is != null && is.getItem() != null
                        && is.getItem() instanceof BaublesAccessory
                        && is.getItemDamage() == 28) shear = true;
                }
            }
            ItemStack stk = player.getCurrentEquippedItem();
            int cost = 1000;
            shear = shear && stk != null
                && stk.getItem() != null
                && stk.getItem() instanceof ItemShears
                && ApiCore.getPlayerData(player)
                    .getPlayerUBMRU() >= cost
            ...
            if (shear) {
                ...
                if (is != null) {
                    ...
                    if (!player.worldObj.isRemote) player.worldObj.spawnEntityInWorld(ent);
                    player.swingItem();
                    ApiCore.getPlayerData(player)
                        .modifyUBMRU(
                            ApiCore.getPlayerData(player)
                ...
                if (player != null) {
                    ...
                    if (b != null) {
                        for (int i = 0; i < b.getSizeInventory(); ++i) {
                            ...
                            if (is != null && is.getItem() != null
                                && is.getItem() instanceof BaublesAccessory
                                && is.getItemDamage() == 27) stopTeleportation = true;
                        }
                    }
            ...
            if (event.source.getSourceOfDamage() != null && event.source.getSourceOfDamage() instanceof EntityPlayer) {
                ...
                if (b != null) {
                    for (int i = 0; i < b.getSizeInventory(); ++i) {
                        ...
                        if (is != null && is.getItem() != null
                            && is.getItem() instanceof BaublesAccessory
                            && is.getItemDamage() == 26) increaseDrops = true;
                    }
                }
                if (increaseDrops && ApiCore.getPlayerData(player)
                    .getPlayerUBMRU() >= 1000) {
                    ApiCore.getPlayerData(player)
                        .modifyUBMRU(
                            ApiCore.getPlayerData(player)
        ...
        if (event.getPlayer() != null) {
            ...
            if (b != null) {
                for (int i = 0; i < b.getSizeInventory(); ++i) {
                    ...
                    if (is != null && is.getItem() != null
                        && is.getItem() instanceof BaublesAccessory
                        && is.getItemDamage() == 23) gainXP = true;
                    if (is != null && is.getItem() != null
                        && is.getItem() instanceof BaublesAccessory
                        && is.getItemDamage() == 24) xpToU = true;
                }
            }
            if (gainXP) {
            ...
            if (xpToU) {
                ...
                ApiCore.getPlayerData(event.getPlayer())
                    .modifyUBMRU(
                        ApiCore.getPlayerData(event.getPlayer())
                            .getPlayerUBMRU() + xp * 1000);
        ...
        if (event.harvester != null) {
            ...
            if (b != null) {
                for (int i = 0; i < b.getSizeInventory(); ++i) {
                    ...
                    if (is != null && is.getItem() != null
                        && is.getItem() instanceof BaublesAccessory
                        && is.getItemDamage() == 22) increaseFortune = true;
                }
            }
            if (increaseFortune && ApiCore.getPlayerData(event.harvester)
                .getPlayerUBMRU() >= 500) {
                ApiCore.getPlayerData(event.harvester)
                    .modifyUBMRU(
                        ApiCore.getPlayerData(event.harvester)
                            .getPlayerUBMRU() - 500);
                for (int i = 0; i < event.drops.size(); ++i) {
                ...
                if (OreDictionary.getOreIDs(is).length != 0) {
                    for (int i : OreDictionary.getOreIDs(is)) {
                        if (OreDictionary.getOreName(i)
                            .equalsIgnoreCase(lapisOreDictName)) {
                            hasLapis = true;
                            break fD;
                        }
                    }
            ...
            if (hasLapis) {
                event.drops.add(
                    new ItemStack(
                        ECItems.genericItem,
                        3 + event.harvester.worldObj.rand.nextInt(8 * (event.fortuneLevel + 1)),
                        51));
            }
        }
    }
    ...
    public void damageEvent(LivingHurtEvent event) {
                ...
                if (event.source.getSourceOfDamage() instanceof EntityPlayer) {
                    ...
                    if (b != null) {
                        for (int i = 0; i < b.getSizeInventory(); ++i) {
                            ...
                            if (is != null && is.getItem() != null
                                && is.getItem() instanceof BaublesAccessory
                                && is.getItemDamage() == 13) reset = true;
                            if (is != null && is.getItem() != null
                                && is.getItem() instanceof BaublesAccessory
                                && is.getItemDamage() == 14) dd = true;
                            if (is != null && is.getItem() != null
                                && is.getItem() instanceof BaublesAccessory
                                && is.getItemDamage() == 16) damageScrewup = true;
                            if (is != null && is.getItem() != null
                                && is.getItem() instanceof BaublesAccessory
                                && is.getItemDamage() == 21) radiation = true;
                        }
                    }
                    if (dd) {
                        event.ammount *= 2;
                    ...
                    if (reset) {
                        if (ApiCore.getPlayerData(player)
                            .getPlayerUBMRU() >= 300) {
                            ApiCore.getPlayerData(player)
                                .modifyUBMRU(
                                    ApiCore.getPlayerData(player)
                    ...
                    if (radiation) {
                        if (event.entityLiving instanceof EntityPlayer) {
                            RadiationUtils.increasePlayerRadiation(
                                (EntityPlayer) event.entityLiving,
                                (int) (event.ammount * 1000 * 5));
                        } else {
        ...
        if (event.entityLiving instanceof EntityPlayer) {
            ...
            if (b != null) {
                for (int i = 0; i < b.getSizeInventory(); ++i) {
                    ...
                    if (is != null && is.getItem() != null
                        && is.getItem() instanceof BaublesAccessory
                        && is.getItemDamage() == 15) saveFromDeath = true;
                    if (is != null && is.getItem() != null
                        && is.getItem() instanceof BaublesAccessory
                        && is.getItemDamage() == 21) radiation = true;
                    if (is != null && is.getItem() != null
                        && is.getItem() instanceof BaublesAccessory
                        && is.getItemDamage() == 25) ++timesToReflect;
                }
            }
            if (dd) {
                event.ammount *= 2;
            ...
            for (int i = 0; i < timesToReflect; ++i) {
                if (!player.worldObj.isRemote && event.source != null
                    && event.source.getSourceOfDamage() != null
                    && player.worldObj.rand.nextFloat() < 0.1F) {
                    event.source.getSourceOfDamage()
                        .attackEntityFrom(DamageSource.causePlayerDamage(player), event.ammount);
                    event.ammount = 0F;
                    break;
                }
            }
            if (saveFromDeath) {
                if (player.getHealth() - event.ammount <= 0) {
                    if (ApiCore.getPlayerData(player)
                        .getPlayerUBMRU() >= event.ammount * 5000) {
                        ApiCore.getPlayerData(player)
                            .modifyUBMRU(
                                (int) (ApiCore.getPlayerData(player)
                                    .getPlayerUBMRU() - event.ammount * 5000));
                        event.ammount = 0;
                    }
                }
            ...
            if (radiation) {
                RadiationUtils.increasePlayerRadiation(player, (int) (event.ammount * 1000));
            }
        } else {
        ...
        if (event.source != null && event.source.getSourceOfDamage() instanceof EntityLivingBase) {
            ...
            if (elb.getHeldItem() != null && elb.getHeldItem()
                .getItem() instanceof ItemShadeSword) {
                ItemShadeSword iss = ItemShadeSword.class.cast(
                    elb.getHeldItem()
                        .getItem());
    ...
    @SubscribeEvent
    public void guiButtonPressed(OnClientButtonPress event) {
        if (event.client_ParentClassPath.equalsIgnoreCase("ec3.client.gui.items.GuiFilter")) {
            EntityPlayer p = event.presser;
            ItemStack is = p.getCurrentEquippedItem();
            NBTTagCompound itemTag = MiscUtils.getStackTag(is);
            if (event.buttonID == 0) {
                if (itemTag.getBoolean("ignoreMeta")) itemTag.setBoolean("ignoreMeta", false);
                else itemTag.setBoolean("ignoreMeta", true);
            }
            if (event.buttonID == 1) {
                if (itemTag.getBoolean("ignoreNBT")) itemTag.setBoolean("ignoreNBT", false);
                else itemTag.setBoolean("ignoreNBT", true);
            }
            if (event.buttonID == 2) {
                if (itemTag.getBoolean("ignoreOreDict")) itemTag.setBoolean("ignoreOreDict", false);
                else itemTag.setBoolean("ignoreOreDict", true);
            }
            is.setTagCompound(itemTag);
        }
        if (event.client_ParentClassPath.equalsIgnoreCase("ec3.client.gui.items.GuiCraftingFrame")) {
            EntityPlayer p = event.presser;
            ItemStack is = p.getCurrentEquippedItem();
            NBTTagCompound itemTag = MiscUtils.getStackTag(is);
            if (event.buttonID == 0) {
        ...
        if (event.client_ParentClassPath.equalsIgnoreCase("ec3.client.gui.logistics.GuiAMINEjector")) {
            TileAMINEjector tile = (TileAMINEjector) event.presser.worldObj.getTileEntity(event.x, event.y, event.z);
            if (event.buttonID == 0) tile.slotnum += 1;
            else tile.slotnum -= 1;
            event.presser
                .openGui(EssentialCraftCore.core, Config.guiID[0], event.presser.worldObj, event.x, event.y, event.z);
        }
        if (event.client_ParentClassPath.equalsIgnoreCase("ec3.client.gui.logistics.GuiAMINInjector")) {
        ...
        if (event.client_ParentClassPath.equalsIgnoreCase("ec3.client.gui.consumers.GuiMagicalAssembler")
            && event.buttonID == 0) {
            TileMagicalAssembler assembler = (TileMagicalAssembler) event.presser.worldObj
        ...
        if (event.client_ParentClassPath.equalsIgnoreCase("ec3.client.gui.crafting.GuiWeaponBench")
            ...
            ++maker.index;
            if (maker.index > 3) maker.index = 0;

            maker.getWorldObj()
                .setBlockMetadataWithNotify(maker.xCoord, maker.yCoord, maker.zCoord, maker.index, 3);
        ...
        if (event.client_ParentClassPath.equalsIgnoreCase("ec3.client.gui.consumers.GuiMagicalAssembler")
            ...
            for (int i = 0; i < assembler.mirrors.size(); ++i) {
                ...
                TileEntity tile = assembler.getWorldObj()
                    .getTileEntity((int) coord.x, (int) coord.y, (int) coord.z);
                if (tile == null || !(tile instanceof TileMagicalMirror)) assembler.mirrors.remove(i);
                else((TileMagicalMirror) tile).end(assembler);
            }
            if (assembler.getStackInSlot(1) != null) assembler.formCraftList(assembler.getStackInSlot(1));
        }
        if (event.client_ParentClassPath.equalsIgnoreCase("ec3.client.gui.consumers.GuiPlayerPentacle")) {
            TilePlayerPentacle pentacle = (TilePlayerPentacle) event.presser.worldObj
                .getTileEntity(event.x, event.y, event.z);

            int reqToConsume = ECUtils.getData(event.presser)
                .getEffects()
                .get(event.buttonID)
                .getStickiness();
            if ((event.additionalData[0].fieldName.equalsIgnoreCase("isCreative")
                && event.additionalData[0].fieldValue.equalsIgnoreCase("true"))
                || pentacle.consumeEnderstarEnergy(reqToConsume)) {
                ECUtils.getData(event.presser)
                    .getEffects()
                    .remove(event.buttonID);
    ...
    public void onBlockSpeedCheck(PlayerEvent.BreakSpeed event) {
        ...
        if (!event.entityPlayer.worldObj.isRemote && currentTool != null
            && (currentTool.getItem() instanceof ItemWindAxe || currentTool.getItem() instanceof ItemWindPickaxe
                || currentTool.getItem() instanceof ItemWindShovel
                || currentTool.getItem() instanceof ItemWindHoe
                || currentTool.getItem() instanceof ItemWindSword)) {
            ...
            if (currentTool.getItem() instanceof ItemPickaxe) currentToolClass = "pickaxe";
            if (currentTool.getItem() instanceof ItemAxe) currentToolClass = "axe";
            if (currentTool.getItem() instanceof ItemSpade) currentToolClass = "shovel";
            if (currentTool.getItem() instanceof ItemHoe) currentToolClass = "hoe";
            if (currentTool.getItem() instanceof ItemSword) currentToolClass = "sword";

            // If the player is using an impropper tool, or the current stack is a sword
            if (!ForgeHooks.isToolEffective(currentTool, event.block, event.metadata)
                || currentToolClass.equalsIgnoreCase("sword")) {
                ...
                if (clazz == null || clazz.isEmpty()) {
                    ...
                    if (event.block != null && event.block.getMaterial() != null) {
                        // Bunch of material checks to make sure lazy modders like me will still get their blocks
                        // recognized properly
                        if (event.block.getMaterial() == Material.anvil) clazz = "pickaxe";
                        if (event.block.getMaterial() == Material.cactus) clazz = "axe";
                        if (event.block.getMaterial() == Material.clay) clazz = "shovel";
                        if (event.block.getMaterial() == Material.coral) clazz = "pickaxe";
                        if (event.block.getMaterial() == Material.craftedSnow) clazz = "shovel";
                        if (event.block.getMaterial() == Material.glass) clazz = "pickaxe";
                        if (event.block.getMaterial() == Material.gourd) clazz = "axe";
                        if (event.block.getMaterial() == Material.grass) clazz = "shovel";
                        if (event.block.getMaterial() == Material.ground) clazz = "shovel";
                        if (event.block.getMaterial() == Material.ice) clazz = "pickaxe";
                        if (event.block.getMaterial() == Material.iron) clazz = "pickaxe";
                        if (event.block.getMaterial() == Material.packedIce) clazz = "pickaxe";
                        if (event.block.getMaterial() == Material.piston) clazz = "axe";
                        if (event.block.getMaterial() == Material.rock) clazz = "pickaxe";
                        if (event.block.getMaterial() == Material.sand) clazz = "shovel";
                        if (event.block.getMaterial() == Material.snow) clazz = "shovel";
                        if (event.block.getMaterial() == Material.sponge) clazz = "shovel";
                        if (event.block.getMaterial() == Material.tnt) clazz = "sword";
                        if (event.block.getMaterial() == Material.web) clazz = "sword";
                        if (event.block.getMaterial() == Material.wood) clazz = "axe";
                    }
                }
                ...
                if (clazz != null && !clazz.isEmpty() && clazz != currentToolClass) {
                    ...
                    // This one will store all the info about the current tool - ID, Meta, Amount and things like
                    // enchantments.
                    ...
                    // Filling in the first tag. At this point it is a huge mess of everyting, so we need to clean it
                    // up.
                    ...
                    if (toolTag.hasKey("tag")) {
                        ...
                        genericTag = (NBTTagCompound) toolTag.getCompoundTag("tag")
                            .copy();

                        // Nullify all other tools data if any
                        toolTag.getCompoundTag("tag")
                            .removeTag("pickaxe");
                        toolTag.getCompoundTag("tag")
                            .removeTag("axe");
                        toolTag.getCompoundTag("tag")
                    ...
                    // Now, since our genericTag is full of every data types, like Enchantments, and we do not want that
                    // to happen we need to clean it up.
                    // I'm doing it by getting every tag there is, wrighting it down into an ArrayList, that way we are
                    // escaping the nasty ConurrentModification
                    // Removing all the necessary data keys from the list, and then removing every element, that maches
                    // any of the keys left in the list.
                    ...
                    if (tagKeyLst.indexOf("pickaxe") != -1) tagKeyLst.remove("pickaxe");
                    if (tagKeyLst.indexOf("axe") != -1) tagKeyLst.remove("axe");
                    if (tagKeyLst.indexOf("shovel") != -1) tagKeyLst.remove("shovel");
                    if (tagKeyLst.indexOf("hoe") != -1) tagKeyLst.remove("hoe");
                    if (tagKeyLst.indexOf("sword") != -1) tagKeyLst.remove("sword");

                    // Iterating through our list, which should have everything, except for our tools in it.
                    // In other words we worked as a gc - we've collected everything we DO NOT need, and now we are
                    // deleting it.
                    for (int i = 0; i < tagKeyLst.size(); ++i) {
                        // This should not be the case, but Mojang does whatever they want with their code, so a safety
                        // check might come into play later, if the code gets changed.
                        if (tagKeyLst.get(i) instanceof String) genericTag.removeTag((String) tagKeyLst.get(i));
                    }
                    ...
                    if (genericTag.hasKey(clazz)) {
                        ...
                        NBTTagCompound loadFrom = (NBTTagCompound) genericTag.getCompoundTag(clazz)
                            .copy();
                        ...
                        // Well... totally unnecessary, but I was tired by that point, and acted like this was a C type
                        // of language. Well, saves gc some bytes, I guess.
                        loadFrom = null;
                    ...
                    // If our tool got replaced. Also, if our tool is a valid item. Should be valid all the times,
                    // but...
                    if (efficent != null && efficent.getItem() != null) {
                        ...
                        if (genericTag.hasKey("pickaxe")) anotherTag.setTag("pickaxe", genericTag.getTag("pickaxe"));
                        if (genericTag.hasKey("axe")) anotherTag.setTag("axe", genericTag.getTag("axe"));
                        if (genericTag.hasKey("shovel")) anotherTag.setTag("shovel", genericTag.getTag("shovel"));
                        if (genericTag.hasKey("hoe")) anotherTag.setTag("hoe", genericTag.getTag("hoe"));
                        if (genericTag.hasKey("sword")) anotherTag.setTag("sword", genericTag.getTag("sword"));

                        // Also setting our current tool into the NBT.
                        // I mean saving, sure.
                        if (toolTag != null) anotherTag.setTag(currentToolClass, toolTag);

                        // And giving our player the new, awesome tool!
                        event.entityPlayer.inventory
                            .setInventorySlotContents(event.entityPlayer.inventory.currentItem, efficent);
                    }
                }
            }
        }
    ...
    public void worldLoadEvent(WorldEvent.Load event) {
        if (event.world != null && !event.world.isRemote
            ...
            File f = event.world.getSaveHandler()
                .getWorldDirectory();
            if (f != null) {
                try {
                    ...
                    if (worldSaveFile.isDirectory()) {
                        throw new IOException(
                            "File is a directory! Please, delete the EC3Data.dat(???) folder in your save and launch the game again!");
                    }
                    if (!worldSaveFile.exists()) {
                        FMLLog.log(
                            Level.WARN,
                            "[EC3]*Server save file not found. This is completely normal if this is your first launch of the save. Otherwise please, report this to the author!");
    ...
    public void worldTick(WorldTickEvent event) {
        if (!event.world.isRemote && event.world != null
            && event.world.provider != null
            && event.world.provider.dimensionId == Config.dimensionID
            ...
            if (ECUtils.hasActiveEvent()) {
                if (WorldEventLibrary.currentEvent == null) {
                    ...
                    } else WorldEventLibrary.currentEventDuration = ECUtils.getActiveEventDuration();
                }
            } else {
    ...
    public void onAimZoom(FOVUpdateEvent event) {
        ...
        if (p.isSneaking() && p.getCurrentEquippedItem() != null
            ...
            && p.getCurrentEquippedItem()
                .getTagCompound()
                .hasKey("scope")) {
            String id = p.getCurrentEquippedItem()
                .getTagCompound()
                .getString("scope");
            ScopeMaterial s = null;
            if (ItemGun.class.cast(
                p.getCurrentEquippedItem()
                    .getItem()).gunType.equalsIgnoreCase("sniper")) {
            ...
            if (s != null) {
                ...
                if (ItemGun.class.cast(
                    p.getCurrentEquippedItem()
                        .getItem()).gunType.equalsIgnoreCase("pistol"))
                    g = GunType.PISTOL;
                if (ItemGun.class.cast(
                    p.getCurrentEquippedItem()
                        .getItem()).gunType.equalsIgnoreCase("rifle"))
                    g = GunType.RIFLE;
                if (ItemGun.class.cast(
                    p.getCurrentEquippedItem()
                        .getItem()).gunType.equalsIgnoreCase("gatling"))
                    g = GunType.GATLING;
                if (g != null) {
    ...
    public void clientTick(TickEvent.ClientTickEvent event) {
        if (event.phase == Phase.START) {
            ...
            if (lastTickLanguage != null && !lastTickLanguage.isEmpty()) {
                if (!lastTickLanguage.equalsIgnoreCase(
            ...
            lastTickLanguage = FMLClientHandler.instance()
                .getCurrentLanguage();
        }
    }
        ...
        if (src != null && src.getSourceOfDamage() != null) {
            ...
            if (e instanceof EntityPlayer && !(e instanceof FakePlayer)) {
                ...
                if (base instanceof EntityPlayer && !(base instanceof FakePlayer)) {
                    int currentEnergy_int = ECUtils.getData((EntityPlayer) base)
                        .getPlayerUBMRU();
                    addedEnergy += currentEnergy_int;
                } else {
                    float maxHp = base.getMaxHealth();
                    ItemStack helmet = player.inventory.armorInventory[3];
                    if (helmet != null && helmet.getItem() == ECItems.magicArmorItems[4]) {
                        player.getFoodStats()
                            .addStats((int) (maxHp / 10F), 1F);
                    }
                    addedEnergy += (20 + (MathUtils.randomFloat(e.worldObj.rand) * 10)) * maxHp;
                }
                if (BaublesApi.getBaubles(player) != null && addedEnergy > 0) for (int i = 0; i < 4; ++i) {
                    ItemStack bStk = BaublesApi.getBaubles(player)
                        .getStackInSlot(i);
                    if (bStk != null) {
                        if (bStk.getItem() != null) {
                            if (bStk.getItem() instanceof IUBMRUGainModifier) {
                                ...
                                addedEnergy = MathHelper.floor_float(
                                    gmod.getModifiedValue(addedEnergy, bStk, player.worldObj.rand, player));
                            }
                        }
                    }
                }
                int currentEnergy_int = ECUtils.getData(player)
                    .getPlayerUBMRU();
                currentEnergy_int += addedEnergy;
                ECUtils.getData(player)
                    .modifyUBMRU(currentEnergy_int);
                ...
                if (b != null) {
                    for (int i = 0; i < b.getSizeInventory(); ++i) {
                        ...
                        if (is != null && is.getItem() != null
                            && is.getItem() instanceof BaublesAccessory
                            && is.getItemDamage() == 12) canDropEmber = true;
                    }
                }
                if (canDropEmber) {
                    if (player.worldObj.rand.nextFloat() < 0.05F) {
                        ItemStack emberStack = new ItemStack(ECItems.ember, 1, player.worldObj.rand.nextInt(8));
                        EntityItem emberItem = new EntityItem(
                            base.worldObj,
                            base.posX,
                            base.posY,
                            base.posZ,
                            emberStack);
                        if (!base.worldObj.isRemote) base.worldObj.spawnEntityInWorld(emberItem);
                    }
                }
            }
        }
        if (base instanceof EntityPlayer) {
            if (!(base instanceof FakePlayer)) ECUtils.getData((EntityPlayer) base)
                .modifyUBMRU(0);
        }
    }

    @SubscribeEvent
    public void onPacketRecieved(OnPacketRecieved event) {
        ...
        if (packetData != null && packetData.length > 0) {
            try {
                ...
                if (modData.fieldName.equalsIgnoreCase("mod")
                    && modData.fieldValue.equalsIgnoreCase("ec3.particle.item")) {
                    ...
                    if (modData.fieldName.equalsIgnoreCase("mod")
                        && modData.fieldValue.equalsIgnoreCase("ec3.item.wings")) {
                        double sX = Double.parseDouble(packetData[1].fieldValue);
                        double sY = Double.parseDouble(packetData[2].fieldValue);
                        double sZ = Double.parseDouble(packetData[3].fieldValue);
                        EntityPlayer player = MinecraftServer.getServer()
                            .getConfigurationManager()
                            .func_152612_a(packetData[4].fieldValue);
                        player.setPosition(sX, sY, sZ);
                        ItemStack wings = BaublesApi.getBaubles(player)
                            .getStackInSlot(3);
                        if (wings != null) {
                    ...
                    if (modData.fieldName.equalsIgnoreCase("mod")
                        && modData.fieldValue.equalsIgnoreCase("ec3.player.position")) {
                        EssentialCraftCore.proxy.handlePositionChangePacket(packetData);
                    } else if (modData.fieldName.equalsIgnoreCase("mod")
                        && modData.fieldValue.equalsIgnoreCase("ec3.sound")) {
